...
.
 ...
 Executable is: CAMx.v7.10.noMPI.NCF4.gfortran

milias@labs.fpv.umb.sk:~/work/software/air_pollution/CAMx/v7.10/src.v7.10/.ldd  CAMx.v7.10.noMPI.NCF4.gfortran
        linux-vdso.so.1 (0x00007ffebd294000)
        libnetcdff.so.6 => /lib/x86_64-linux-gnu/libnetcdff.so.6 (0x00007fb72422e000)
        libnetcdf.so.13 => /lib/x86_64-linux-gnu/libnetcdf.so.13 (0x00007fb7240ed000)
        libgfortran.so.5 => /lib/x86_64-linux-gnu/libgfortran.so.5 (0x00007fb723e7f000)
        libm.so.6 => /lib/x86_64-linux-gnu/libm.so.6 (0x00007fb723cfc000)
        libgcc_s.so.1 => /lib/x86_64-linux-gnu/libgcc_s.so.1 (0x00007fb723ce2000)
        libquadmath.so.0 => /lib/x86_64-linux-gnu/libquadmath.so.0 (0x00007fb723ca0000)
        libc.so.6 => /lib/x86_64-linux-gnu/libc.so.6 (0x00007fb723add000)
        libdl.so.2 => /lib/x86_64-linux-gnu/libdl.so.2 (0x00007fb723ad8000)
        libz.so.1 => /lib/x86_64-linux-gnu/libz.so.1 (0x00007fb7238ba000)
        libcurl-gnutls.so.4 => /lib/x86_64-linux-gnu/libcurl-gnutls.so.4 (0x00007fb72382c000)
        libpthread.so.0 => /lib/x86_64-linux-gnu/libpthread.so.0 (0x00007fb72380b000)
        libhdf5_serial_hl.so.100 => /lib/x86_64-linux-gnu/libhdf5_serial_hl.so.100 (0x00007fb7237e5000)
        libhdf5_serial.so.103 => /lib/x86_64-linux-gnu/libhdf5_serial.so.103 (0x00007fb72345e000)
        libsz.so.2 => /lib/x86_64-linux-gnu/libsz.so.2 (0x00007fb72325b000)
        /lib64/ld-linux-x86-64.so.2 (0x00007fb764656000)
        libnghttp2.so.14 => /lib/x86_64-linux-gnu/libnghttp2.so.14 (0x00007fb723233000)
        libidn2.so.0 => /lib/x86_64-linux-gnu/libidn2.so.0 (0x00007fb723214000)
        librtmp.so.1 => /lib/x86_64-linux-gnu/librtmp.so.1 (0x00007fb722ff7000)
        libssh2.so.1 => /lib/x86_64-linux-gnu/libssh2.so.1 (0x00007fb722fc7000)
        libpsl.so.5 => /lib/x86_64-linux-gnu/libpsl.so.5 (0x00007fb722fb4000)
        libnettle.so.6 => /lib/x86_64-linux-gnu/libnettle.so.6 (0x00007fb722f7c000)
        libgnutls.so.30 => /lib/x86_64-linux-gnu/libgnutls.so.30 (0x00007fb722dcf000)
        libgssapi_krb5.so.2 => /lib/x86_64-linux-gnu/libgssapi_krb5.so.2 (0x00007fb722d82000)
        libkrb5.so.3 => /lib/x86_64-linux-gnu/libkrb5.so.3 (0x00007fb722ca2000)
        libk5crypto.so.3 => /lib/x86_64-linux-gnu/libk5crypto.so.3 (0x00007fb722c6c000)
        libcom_err.so.2 => /lib/x86_64-linux-gnu/libcom_err.so.2 (0x00007fb722c66000)
        libldap_r-2.4.so.2 => /lib/x86_64-linux-gnu/libldap_r-2.4.so.2 (0x00007fb722c12000)
        liblber-2.4.so.2 => /lib/x86_64-linux-gnu/liblber-2.4.so.2 (0x00007fb722c01000)
        libaec.so.0 => /lib/x86_64-linux-gnu/libaec.so.0 (0x00007fb7229f9000)
        libunistring.so.2 => /lib/x86_64-linux-gnu/libunistring.so.2 (0x00007fb722873000)
        libhogweed.so.4 => /lib/x86_64-linux-gnu/libhogweed.so.4 (0x00007fb72283a000)
        libgmp.so.10 => /lib/x86_64-linux-gnu/libgmp.so.10 (0x00007fb7227b7000)
        libgcrypt.so.20 => /lib/x86_64-linux-gnu/libgcrypt.so.20 (0x00007fb722699000)
        libp11-kit.so.0 => /lib/x86_64-linux-gnu/libp11-kit.so.0 (0x00007fb72256a000)
        libtasn1.so.6 => /lib/x86_64-linux-gnu/libtasn1.so.6 (0x00007fb722357000)
        libkrb5support.so.0 => /lib/x86_64-linux-gnu/libkrb5support.so.0 (0x00007fb722346000)
        libkeyutils.so.1 => /lib/x86_64-linux-gnu/libkeyutils.so.1 (0x00007fb72233f000)
        libresolv.so.2 => /lib/x86_64-linux-gnu/libresolv.so.2 (0x00007fb722325000)
        libsasl2.so.2 => /lib/x86_64-linux-gnu/libsasl2.so.2 (0x00007fb722308000)
        libgpg-error.so.0 => /lib/x86_64-linux-gnu/libgpg-error.so.0 (0x00007fb7222e5000)
        libffi.so.6 => /lib/x86_64-linux-gnu/libffi.so.6 (0x00007fb7222d9000)
