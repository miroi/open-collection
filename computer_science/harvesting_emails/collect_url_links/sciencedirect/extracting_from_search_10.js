// ============================================================
// MODIFIED: SCIENCE DIRECT EMAIL EXTRACTOR - SHOW EMAILS ONLY
// ============================================================
// Shows only email addresses in each tab, not article counts.
// ============================================================
            ...
            if (newTab) {
                ...
                setTimeout(() => {
                    try {
                        ...
                        script.textContent = `
                            // ============================================================
                            // TAB SCRIPT - DRAGGABLE WINDOW WITH EMAILS ONLY
                            // ============================================================
                            (function() {
                                ...
                                // ============================================================
                                // DRAGGABLE PROGRESS UI - EMAILS ONLY
                                // ============================================================
                                function createProgressUI() {
                                    ...
                                    content.innerHTML = \`
                                        ...
                                        <div id="progressStatus" style="color: #aaa; font-size: 13px; margin-bottom: 4px;">⏳ Searching...</div>
                                        <div id="progressDetail" style="color: #888; font-size: 12px;">Looking for emails</div>
                                        ...
                                        <div id="emailList" style="margin-top: 8px; font-size: 12px; color: #4CAF50; max-height: 150px; overflow-y: auto; border-top: 1px solid #333; padding-top: 6px; display: none;"></div>
                                    \`;
                                ...
                                console.log("👤 Auto-extractor started with draggable progress UI!");
                            })();
                        `;
...
// ============================================================
console.log("\n" + "=".repeat(60));
console.log("📧 SCIENCE DIRECT EMAIL EXTRACTOR - EMAILS ONLY");
console.log("=".repeat(60));
console.log(`🆔 Session ID: ${SESSION_ID}`);
console.log(`💡 Tabs open in BACKGROUND - focus stays here!`);
console.log(`📁 This window's data is ISOLATED from other windows`);
console.log(`🖱️ Progress windows are DRAGGABLE - click and drag to move!`);
console.log(`📧 Each tab shows ONLY the emails found (not article counts)`);
console.log("\n📌 Commands:");
