...
class VibrationCalculator:
    ...
    def calculate_1d_scan(self, atoms, mol_name, delta=0.005, n_points=7):
        """
        ...
        try:
            ...
            if second_deriv <= 0:
                ...
                if n_points < 11:
                    ...
                    return self.calculate_1d_scan(atoms, mol_name, delta, n_points + 2)
                return 0.0
    ...
    def calculate_xonly_hessian(self, atoms, mol_name, delta=0.005, nfree=2):
        """
        ...
        try:
            ...
            atoms.set_constraint(original_constraints)
            return self.calculate_1d_scan(atoms, mol_name, delta, 7)
    
    def calculate_full_hessian(self, atoms, mol_name, delta=0.005, nfree=2):
        """
