...
atoms = Atoms(
    ...
    positions=[ # positions in Angstrom
        ...
        [1.2331606817266494, 0.7119656511482136, 7.5000000000000000]
    ],
    cell=[ # positions in Angstrom
        [2.4663215096651858, 0.0000000000000000, 0.0000000000000000],
        [-1.2331607548325929, 2.1358970812796234, 0.0000000000000000],
...
projwfc_command = f'mpirun -np 8 {qe_bin}/projwfc.x < projwfc.in > projwfc.out 2>&1'
