...
#mpirun -np $NPROCS_PBS  $NWCHEM_EXECUTABLE  $PBS_O_WORKDIR/GB.b3lyp_cosmo.nw  > $PBS_O_WORKDIR/nwchem.out
mpirun -np $NPROCS_PBS  $NWCHEM_EXECUTABLE  $PBS_O_WORKDIR/GB.b3lyp_cosmo_chloroform.nw > $PBS_O_WORKDIR/GB.b3lyp_cosmo_chloroform.out
