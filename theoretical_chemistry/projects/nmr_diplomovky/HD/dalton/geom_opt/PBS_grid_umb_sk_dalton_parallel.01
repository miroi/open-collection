...
#PBS -l nodes=1:ppn=12  # number of CPUs for Dalton parallel run
...
#PBS -M emacusova@studenti.umb.sk  # send email after finishing job
...
# this is parallel run 
   ...
   $DALTON/$BUILD/dalton -N $NPROCS_PBS  -noarch VX.b3lyp_geomopt_freq_pcm_h2o  VX.6-311G
