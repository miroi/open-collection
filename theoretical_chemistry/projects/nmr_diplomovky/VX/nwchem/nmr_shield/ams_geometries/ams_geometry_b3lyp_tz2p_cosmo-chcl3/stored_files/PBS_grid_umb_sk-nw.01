...
#cp $PBS_O_WORKDIR/VX_geom_ccpvdz-034-again.xyz   $TMPDIR/.
cp $PBS_O_WORKDIR/VX.converged_geometry_blyp_tz2p-solvent-chcl3.xyz   $TMPDIR/.
project=VX.nmrshield_b3lyp_ccpvtz_cosmo-chcl3
mpirun -np $NPROCS_PBS  $NWCHEM_EXECUTABLE  $PBS_O_WORKDIR/$project.nw  > $PBS_O_WORKDIR/$project.out
#cp $TMPDIR/VX_geom_ccpvtz*   $PBS_O_WORKDIR/.
