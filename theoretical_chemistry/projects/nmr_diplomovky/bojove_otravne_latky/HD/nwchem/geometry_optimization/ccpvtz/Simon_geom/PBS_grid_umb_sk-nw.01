...
#mpirun -np $NPROCS_PBS  $NWCHEM_EXECUTABLE  $PBS_O_WORKDIR/HD.b3lyp_3-21G_geopt_shield.nw  > $PBS_O_WORKDIR/HD.b3lyp_3-21G_geopt_shield.out

#cp $PBS_O_WORKDIR/HD_konformer81.xyz   $TMPDIR/.
cp $PBS_O_WORKDIR/HD_geom_Simon.xyz   $TMPDIR/.
project=HD.geoptC2v_freq-an_b3lyp_ccpvtz
mpirun -np $NPROCS_PBS  $NWCHEM_EXECUTABLE  $PBS_O_WORKDIR/$project.nw  > $PBS_O_WORKDIR/$project.out
#cp $TMPDIR/HD_geom_ccpvtz_again*   $PBS_O_WORKDIR/.
cp $TMPDIR/HD_geomSimon_ccpvtz_again   $PBS_O_WORKDIR/.
