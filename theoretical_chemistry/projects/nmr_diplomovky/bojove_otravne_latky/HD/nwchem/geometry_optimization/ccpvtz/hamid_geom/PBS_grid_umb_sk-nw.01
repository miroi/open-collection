...
#cp $PBS_O_WORKDIR/HD_geom_ccpvtz.xyz   $TMPDIR/.
cp $PBS_O_WORKDIR/HD_hamid.xyz   $TMPDIR/.
project=HD.geopt-hamid_freq_b3lyp_ccpvtz
mpirun -np $NPROCS_PBS  $NWCHEM_EXECUTABLE  $PBS_O_WORKDIR/$project.nw  > $PBS_O_WORKDIR/$project.out
cp $TMPDIR/HD_geom_ccpvtz_fromhamid*   $PBS_O_WORKDIR/.
