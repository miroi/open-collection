...
cp $PBS_O_WORKDIR/TMS.converged_geometry_pbe0_tz2p_good_cosmo-chcl3.xyz   $TMPDIR/.
project=TMS.nmrshield_b3lyp_6-311++g2d_2p_cosmo-chcl3
mpirun -np $NPROCS_PBS  $NWCHEM_EXECUTABLE  $PBS_O_WORKDIR/$project.nw  > $PBS_O_WORKDIR/$project.out
#cp $TMPDIR/TMS_geom*   $PBS_O_WORKDIR/.
