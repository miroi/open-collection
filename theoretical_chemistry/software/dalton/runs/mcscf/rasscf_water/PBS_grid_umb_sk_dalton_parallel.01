...
#PBS -l nodes=1:ppn=4  # number of CPUs for Dalton parallel run
...
# this is parallel run 
   #$DALTON/$BUILD/dalton -N $NPROCS_PBS  -noarch  b3lyp_shield_spin_pcm C2H3Li_STO-3G
   $DALTON/$BUILD/dalton -N $NPROCS_PBS  -noarch H2O.rasscf_prop H2O.C2v
