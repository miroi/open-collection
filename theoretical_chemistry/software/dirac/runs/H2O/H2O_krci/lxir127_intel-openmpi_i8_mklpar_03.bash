...
cd $DIRACBIN
ctest  -v -R lucita_q_corrections krci_energy_q_corrections
ctest  -v -R krci_energy_q_corrections


#$PAM --noarch --mpi=4  --gb=1.89 --ag=1.99 --mol=CO.mol  --inp=ccsd.small.inp  --suffix=$SLURM_JOB_PARTITION-$SLURM_JOBID-out 
#$PAM --help

#$PAM --noarch --inp=scf-casscf.inp  --mol=h2o.xyz --outkrmc --get="refvec.luci"

#$PAM --noarch --inp=krci-q.inp  --mol=h2o.xyz --inkrmc --put="refvec.luci"
#$PAM --noarch --inp=scf-casscf.inp  --mol=h2o.xyz --inkrmc --put="refvec.luci"
