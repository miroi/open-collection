...
# 1. Silenced at OS level: redirect MOPAC executable stdout/stderr to devnull
#os.environ['ASE_MOPAC_COMMAND'] = 'path/to/mopac > /dev/null 2>&1'
os.environ['ASE_MOPAC_COMMAND'] = '/usr/bin/mopac > /dev/null 2>&1'
