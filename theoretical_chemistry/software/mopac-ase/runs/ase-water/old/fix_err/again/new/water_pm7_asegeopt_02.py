...
# 1. Set the environment variable to use the expect wrapper
...
if not os.path.exists(wrapper_path):
    ...
    print("Please create mopac_wrapper.sh with the expect script content")
    sys.exit(1)
...
# 3. Set up MOPAC calculator with a label
calc = MOPAC(
    method='PM7',
    task='1SCF GRADIENTS',
    label='water_opt'
...
try:
    ...
    # Check output files for debugging
