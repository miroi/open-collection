...
pw_command = f'mpirun -v -np {os.environ["SLURM_NTASKS"]} -machinefile nodes.{os.environ["SLURM_JOB_PARTITION"]}.{os.environ["SLURM_JOB_ID"]} --bind-to core:overload-allowed {qe_bin}/bin/pw.x -npool {os.environ["SLURM_JOB_NUM_NODES"]}'
